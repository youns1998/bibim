...
void printkoreanui()
{
	...
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. 曹 旋 翱蝗     弛    2. 穠擎 旋 翱蝗     弛    3. 顫濠 翱蝗 啪歜   弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 戍式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扣\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
...
void printkrfirst()
{
	...
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      ");BLUE;
	printf("1. 曹 旋 翱蝗     "); WHITE;
	printf("弛    2. 穠擎 旋 翱蝗     弛    3. 顫濠 翱蝗 啪歜   弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
...
void printkrsecond()
{
	...
	printf(" 忙式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式忖\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. 曹 旋 翱蝗     弛    "); BLUE;
	printf("2. 穠擎 旋 翱蝗    " );WHITE;
	printf(" 弛    3. 顫濠 翱蝗 啪歜   弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
...
void printkrthird()
{
	...
	printf(" 忙式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式忖\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. 曹 旋 翱蝗     弛    2. 穠擎 旋 翱蝗     弛    "); BLUE;
	printf("3. 顫濠 翱蝗 啪歜   "); WHITE;
	printf("弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
...
void printcodeui()
{
	printf(" 忙式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式忖\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. C樹橫 翱蝗     弛       2. C++翱蝗       弛      3. 囀註 啪歜      弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 戍式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扣\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
...
void printcdfirst()
{
	...
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛  ");BLUE;
	printf("    1. C樹橫 翱蝗     "); WHITE;
	printf("弛       2. C++翱蝗       弛      3. 囀註 啪歜      弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛                        戌式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扣\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
...
void printcdsecond()
{
	printf(" 忙式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式忖\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. C樹橫 翱蝗     弛 "); BLUE;
	printf("      2. C++翱蝗      "); WHITE;
	printf(" 弛      3. 囀註 啪歜      弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 戍式式式式式式式式式式式式式式式式式式式式式式式式戎                        戌式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式扣\n ");
	printf("弛                                                                                                   弛\n ");
	printf("弛                                                                                                   弛\n ");
...
void printcdthird()
{
	printf(" 忙式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式忖\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 弛      1. C樹橫 翱蝗     弛       2. C++翱蝗       弛 "); BLUE;
	printf("     3. 囀註 啪歜      "); WHITE;
	printf("弛     4. 顫檜ぎ煎 檜翕   弛\n");
	printf(" 弛                        弛                        弛                        弛                        弛\n");
	printf(" 戍式式式式式式式式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式戎                        戌式式式式式式式式式式式式式式式式式式式式式式式式扣\n ");
	printf("弛                                                                                                   弛\n ");
...
void rank_menu()
{
	while (1)
	{
		...
		printf(" 弛                                              弛\n ");
		printf("弛              1. 橾奩 顫濠 楨韁               弛\n");
		printf(" 弛              2. 囀註 楨韁                    弛\n");
		printf(" 弛              3. 顫檜ぎ煎 檜翕                弛\n");
		printf(" 弛                                              弛\n");
